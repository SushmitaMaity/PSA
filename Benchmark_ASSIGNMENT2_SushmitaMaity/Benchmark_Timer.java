...
//    random, ordered, partially-ordered and reverse-ordered
    public static void main(String[] args) {
        ...
        for (int n = 50; n < 4000; n = n * 2) {

            Consumer<Integer[]> consumer = arr -> insertionSort.sort(arr, 0, arr.length);
            Benchmark_Timer<Integer[]> benchmark_timer = new Benchmark_Timer<>("Random Array: " + n, consumer);
            Integer[] arr = new Integer[n];
            for (int i = n - 1; i >= 0; i--)
                arr[i] = random.nextInt();
            consumer.accept(arr);
            System.out.println(benchmark_timer.run(arr, numOfRuns));
        }

        System.out.println("Ordered Array");
        for (int n = 50; n < 4000; n = n * 2) {
            Consumer<Integer[]> consumer = arr -> insertionSort.sort(arr, 0, arr.length);
            Benchmark_Timer<Integer[]> benchmark_timer = new Benchmark_Timer<>("Ordered Array: " + n, consumer);
            Integer[] arr = new Integer[n];
            for (int i = 0; i < n; i++)
                arr[i] = i;
            consumer.accept(arr);
        ...
        for (int n = 50; n < 4000; n = n * 2) {
            Consumer<Integer[]> consumer = arr -> insertionSort.sort(arr, 0, arr.length);
            Benchmark_Timer<Integer[]> benchmark_timer = new Benchmark_Timer<>("Partially Ordered Array: " + n, consumer);
            Integer[] arr = new Integer[n];
            for (int i = 0; i < n/2; i++)
                arr[i] = i;
        ...
        for (int n = 50; n < 4000; n = n * 2) {
            Consumer<Integer[]> consumer = arr -> insertionSort.sort(arr, 0, arr.length);
            Benchmark_Timer<Integer[]> benchmark_timer = new Benchmark_Timer<>("Reverse-Ordered Array: " + n, consumer);
            Integer[] arr = new Integer[n];
            for (int i = n - 1; i >= 0; i--)
                arr[i] = i;
            consumer.accept(arr);
